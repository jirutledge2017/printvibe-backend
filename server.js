...
- Show Your Colors — two children pull back a grey curtain to reveal a wall blazing with Hope, Freedom, Dream, Love, Equality, Peace. Story: the world hands you a stage the color of ash and says that's all there is, until someone brave enough pulls the curtain back and the whole spectrum was waiting behind it. The color was never gone — someone just has to reveal it. A beautiful piece for a child's room or anyone who needs hope made loud.
- Hold My Hand — two children on a swing, hands clasped, graphite against an explosion of watercolor. Story: before the world made love complicated, there was just a shared swing, a held hand, and a sky bursting with color. The simplest kind of certainty you spend a life finding your way back to. For the rooms where love lives.
- Still Human — a masked, armored figure cradling a single red beating heart against greyscale. Story: they can plate you in armor and mask your face, but one red heart held in an open hand refuses to go grey with the rest of you. For anyone the world tried to harden — underneath all of it, you're still human.
- Liquid Spectrum — rivers of blue, green, gold and crimson poured into hypnotic marbled motion. Story: pour every color you've ever felt into one place and let them touch — joy and grief and everything between, marbled into one endless current. For a room that needs to breathe; some feelings were never meant to hold still.
- Silver Tears — a queen crowned in beadwork, cowrie shells and silver, face lifted as liquid-silver tears fall, in flawless monochrome. Story: she wears her heritage like a crown and does not lower her face to cry; the tears come anyway, molten and unashamed. Grief that refuses to look like weakness — she breaks, and stays a queen through all of it.
